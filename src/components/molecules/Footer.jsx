        ...
        <Box border="1" fontWeight="700" bgColor="#E5E5EA" color="#444444" align="center">
            <Flex p={{base:"8", xl:"50px 0"}} maxW="1272px" align="center" direction={{base: "column", md: "row"}} >
                ...
                <Flex align="center">
                    ...
                    <Button colorScheme="orange" size="lg" variant="solid" bgColor="#EF6724" borderRadius="full">Sign Up</Button>
                </Flex>
            </Flex>
            <Box p="8" bgColor="#eeeeee" color="#444444" align="center"  >
            ...
            <Box p="3" bgGradient="linear(to-r, #EF6724, #EF9123)" color="white" align="center"  >
